 ...
 */
@WebServlet("/ThirdPageUpdateDataServlet")
public class ThirdPageUpdateDataServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		System.out.println("Data has been saved " + thirdPageDTO
				+ thirdPageScoreDTO);
		try {
			if (JDBC.updateThirdPageStudentData(thirdPageDTO)) {
